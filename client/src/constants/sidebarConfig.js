  ...
  PlacementOfficer: [
    {
      ...
      items: [
        ...
        { label: 'Students', path: '/officer/students', icon: 'GraduationCap' },
        { label: 'Eligibility', path: '/officer/eligibility', icon: 'ClipboardCheck' },
        { label: 'Mentors', path: '/officer/mentors', icon: 'UserCheck' },
        { label: 'Opportunities', path: '/officer/opportunities', icon: 'Briefcase' },
        { label: 'Announcements', path: '/officer/announcements', icon: 'Megaphone' },
        { label: 'Activity Logs', path: '/officer/activity-logs', icon: 'ScrollText' },
